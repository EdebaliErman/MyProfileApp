...
import "./DowloadCvButton.css"
function DowloadCvButton() {
    const handleDowload = () => {
        const link = document.createElement('a')
        link.href = process.env.PUBLIC_URL + '/assets/Edebali_Erman.pdf'
        link.setAttribute('download', 'Edebali_Erman.pdf');
